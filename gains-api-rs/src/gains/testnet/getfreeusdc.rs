...
use crate::blockchain_constants::token_constants::USDC_ADDRESS_SEPOLIA;
...
pub async fn get_free_usdc(
    ...
    trading_contract = *USDC_ADDRESS_SEPOLIA;
    ...
    match priv_key_from_db {
        Some(priv_key_str) => {
            ...
            abigen!(GainsNetworkCollateralUSDC, "./gains_abi/testnet/GainsNetworkCollateralUSDC_abi.json");
