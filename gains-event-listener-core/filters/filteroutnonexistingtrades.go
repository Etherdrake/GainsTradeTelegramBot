...
// FilterOutNonExistingTrades filters out trades that are not present in the database and returns them as TradeItemMongo
func FilterOutNonExistingTrades(ctx context.Context, collection *mongo.Collection, streamTradesArr []types.TradeItemMongo) ([]types.TradeItemMongo, error) {
