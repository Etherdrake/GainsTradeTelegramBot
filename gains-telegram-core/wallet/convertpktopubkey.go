...
func ConvertPrivateKeyToPublicKey(privateKeyString string) (string, error) {
	...
	return hexutil.Encode(hash.Sum(nil)[12:]), nil // 0x96216849c49358b10257cb55b28ea603c874b05e
}
