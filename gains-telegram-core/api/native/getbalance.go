...
// GetBalanceOf returns the balance of the specified account
func GetBalanceOf(requestData BalanceOfPayload) (string, error) {
	...
	if err != nil {
		return "POST error: CHECK IF THE API IS RUNNING", err
	}
	...
	if err != nil {
		return "BalanceResponse Error", err
	}
